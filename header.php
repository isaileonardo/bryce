...
<header id="t3-mainnav" class="wrap navbar navbar-default navbar-fixed-top t3-mainnav">
    ...
    <?php if ($this->countModules('redes-sociales')) : ?>
    <!-- REDES SOCIALES -->
    <section class="redes-sociales<?php $this->_c('redes-sociales')?> navbar-inverse">    
    	<div class="container">
    		<div class="row">
    		<div class="block">
      		<jdoc:include type="modules" name="<?php $this->_p('redes-sociales') ?>" style="raw" />
      		</div>
      		</div>
      	</div>
    </section>
